    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
              "Also, be aware that this site is scrollable, so if it apears that something has been cut off at the bottom, try to scroll down.",
              style: TextStyle(
                  color: Colors.deepPurpleAccent.shade100, fontSize: 20)),
          Text("Thank you again for visiting my portfolio!",
              style: TextStyle(
                  color: Colors.deepPurpleAccent.shade100, fontSize: 40))
        ],
      ),
